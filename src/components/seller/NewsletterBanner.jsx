  ...
  return (
    <div className="mt-12">
      <div className="mx-auto max-w-7xl px-4">
        <div className="overflow-hidden rounded-2xl bg-slate-700 px-6 py-8 text-white sm:px-8 sm:py-10 md:px-12 lg:px-14 lg:py-12"> 
            ...
            <div className="min-w-0">
              ...
              <div className="mt-6 flex flex-col overflow-hidden rounded-lg bg-white sm:flex-row">
                ...
                <input
                  ...
                  className="w-full min-w-0 px-2 py-3 text-slate-800 outline-none"
                />
